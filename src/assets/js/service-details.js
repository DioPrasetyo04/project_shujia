...
const swiperSliderCustomer = new Swiper("#GreatCustomersSlider", {
  direction: "horizontal",
  slidesPerView: "auto",
  loop: true,
  speed: 1000, // kecepatan (besar = lebih lambat tapi halus)
  allowTouchMove: true, // tetap bisa swipe manual
  navigation: {
